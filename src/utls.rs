...
pub fn safari_fingerprint() -> TlsFingerprint {
    TlsFingerprint {
        ...
        extensions: vec![
            0x0000, 0x0017, 0xFF01, 0x000A, 0x000B, 0x0023, 0x000D, 0x0010, 0x0005,
        ],
...
pub fn rotate_fingerprint(fp: &mut TlsFingerprint) {
    ...
    let grease =
        crate::stealth::GREASE_VALUES[rng.gen_range(0..crate::stealth::GREASE_VALUES.len())];
...
pub fn ja3_string(fp: &TlsFingerprint) -> String {
    ...
    format!(
        "{},{},{},{}-{}",
        fp.version, ciphers, exts, curves, fp.point_formats[0]
    )
}
